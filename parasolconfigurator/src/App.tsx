...
function App() {
  ...
  const [parasol, setParasol] = useState<Parasol>({ size: "M", });

  const handleSetParasolSize = (size: string) => {
    setParasol({
      ...parasol,
      size: size
    })
  ...
  return (
    <PanelGroup direction='horizontal'>
        ...
        <Panel minSize={25} collapsible>
          <SettingsMenu setFootSize={handleSetFootSize} setParasolSize={handleSetParasolSize} />
        </Panel>
    </PanelGroup>
  )
}
