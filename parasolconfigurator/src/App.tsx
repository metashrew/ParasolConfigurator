...
function App() {
  ...
  const layoutQuery = window.matchMedia("(max-width: 800px)")
  
  return (
    <PanelGroup direction={layoutQuery ? 'horizontal' : 'vertical'}>
        ...
        <Panel minSize={25} maxSize={75} collapsible style={{backgroundColor: "#eee"}}>
